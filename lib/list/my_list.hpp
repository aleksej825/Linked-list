...
// typedef int (*compare_list_elements_fn) (struct list_element<T>*, struct list_element<T>*);
...
class linkedList{
    ...
    struct list_element<T>* create_list_element( void* new_data, size_t data_size );
